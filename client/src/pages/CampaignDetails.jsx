    ...
    <div>
      ...
      mt-10 gap-[30px]'>
        ...
        justify-between gap-[30px]'>
          ...
          <CountBox title="Amount Raised" value={state.amountCollected} />
      ...
      <div className='mt-[40px] flex lg:flex-row flex-col gap-5'>
        <div className='flex-[2] flex flex-col gap-[40px]'>
          ...
          <div>
            ...
            <div className='mt-[10px]'>
              ...
              leading-[26px] text-justify'>{state.description}</p>
            </div>
          </div>
        ...
        <div className='flex-1'>
          <h4 className='font-epilogue font-semibold text-[18px] 
            ...
            <div className='my-[20px] flex flex-col p-4 bg-[#1c1c24]
            rounded-[10px]'> 
              ...
              <div className='mt-[30px]'>
                <input
                  ...
                  rounded-[10px]'>
                    <h4 className='font-epilogue font-semibold
                    text-[14px] leading-[22px] text-white'>Back the campaign</h4>
                    <p className='mt-[20px] font-epilogue
                    font-normal leading-[22px] text-[#808191]'>
                    Support the project for no reward</p>
                  </div>

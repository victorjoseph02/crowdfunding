        ...
        <div className='flex flex-col p-4'>
            <div className='flex flex-row items-center mb-[18px]'>
                <img src={tagType} alt='tag' className='w-[17px] h-[17px]
                 object-contain'/>
                 <p className='ml-[12px] mt-[2px] font font-epilogue
                 font-medium text-[12px] text-[#808191]'>Education
                 </p>
            </div>

            <div className='block'>
                <h3 className='font-epilogue font-semibold
                text-[16px] text-white text-left leading-[26px] truncate'>
                {title}</h3>
            ...
            mt-[15px] gap-2'>
                <div className='flex flex-col'>
                    ...
                    text-[14px] text-[#b2b3bd] leading-[22px]'>
                    {amountCollected}</h4>
                ...
                <div className='flex items-center mt-[20px] gap-[12px]'>
                    ...
                    text-[12px] text-[#808191] truncate max-w-[calc(100%-42px)]'>by <span className='text-[#b2b3bd]'>{owner}</span></p>
                </div>
            </div>
        </div>
    </div>
